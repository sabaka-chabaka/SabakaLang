...
1. Download the latest release from the [releases page](https://github.com/sabaka-chabaka/SabakaLang/releases).
2. Run the installer
...
## Documentation
For more detailed documentation, visit the [Wiki](https://github.com/sabaka-chabaka/SabakaLang/wiki).
